...
var dist = createCommonjsModule(function(module, exports) {
  ...
  is.buffer = value =>
    ...
    !is.nullOrUndefined(value.constructor) &&
    is.function_(value.constructor.isBuffer) &&
  ...
  is.primitive = value =>
    is.null_(value) || primitiveTypeOfTypes.has(typeof value);
...
class CacheableRequest {
  ...
  createCacheableRequest(request) {
    return (opts, cb) => {
      ...
      const ee = new events();
      const normalizedUrlString = normalizeUrl_1(url.format(url$1), {
        stripWWW: false,
      ...
      const makeRequest = opts => {
        ...
        const handler = response => {
          if (revalidate && !opts.forceRefresh) {
            ...
            const revalidatedPolicy = httpCacheSemantics
              .fromObject(revalidate.cachePolicy)
...
class CacheableLookup {
  ...
  lookup(hostname, options, callback) {
    ...
    this.lookupAsync(hostname, { ...options, throwNotFound: true })
      .then(result => {
        if (options.all) {
  ...
  async lookupAsync(hostname, options = {}) {
    ...
    if (!options.family && options.all) {
      const [cached4, cached6] = await Promise.all([
        this.lookupAsync(hostname, { all: true, family: 4, details: true }),
    ...
    cached = cached.filter(
      entry => !Reflect.has(entry, "expires") || now < entry.expires
    );
...
var isFormData = createCommonjsModule(function(module, exports) {
  ...
  exports.default = body =>
    dist.default.nodeStream(body) && dist.default.function_(body.getBoundary);
});
  ...
  function merge(target, ...sources) {
    for (const source of sources) {
      for (const [key, sourceValue] of Object.entries(source)) {
        ...
        if (
          dist.default.urlInstance(targetValue) &&
          dist.default.string(sourceValue)
        ) {
...
var optionsToUrl = createCommonjsModule(function(module, exports) {
  ...
  exports.default = options => {
    ...
    if (options.origin) {
      ...
      origin = `${options.protocol}//${((_b =
        ((_a = options.hostname),
        _a !== null && _a !== void 0 ? _a : options.host)),
    ...
    if (options.searchParams) {
      if (
        ...
        !(options.searchParams instanceof url.URLSearchParams)
      ) {
...
var normalizeArguments = createCommonjsModule(function(module, exports) {
  ...
  exports.preNormalizeArguments = (options, defaults) => {
    ...
    // `options.prefixUrl`
    if (
      dist.default.urlInstance(options.prefixUrl) ||
      dist.default.string(options.prefixUrl)
    ) {
    ...
    if (dist.default.object(options.hooks)) {
      for (const event of knownHookEvents_1.default) {
        if (Reflect.has(options.hooks, event)) {
          if (!dist.default.array(options.hooks[event])) {
            throw new TypeError(
              `Parameter \`${event}\` must be an Array, not ${dist.default(
                options.hooks[event]
              )}`
            );
          }
      ...
      throw new TypeError(
        `Parameter \`hooks\` must be an Object, not ${dist.default(
          options.hooks
        )}`
      );
    }
    if (defaults) {
      for (const event of knownHookEvents_1.default) {
        if (
          !(
            Reflect.has(options.hooks, event) &&
            dist.default.undefined(options.hooks[event])
          )
        ) {
    ...
    if (options.retry.maxRetryAfter === undefined) {
      options.retry.maxRetryAfter = Math.min(
        ...[options.timeout.request, options.timeout.connect].filter(
          n => !dist.default.nullOrUndefined(n)
        )
      );
    }
    ...
    if (
      options.dnsCache &&
      !(options.dnsCache instanceof cacheableLookup.default)
    ) {
      options.dnsCache = new cacheableLookup.default({
    ...
    if (dist.default.string(options.method)) {
      ...
      options.method =
        ((_b = (_a = defaults) === null || _a === void 0 ? void 0 : _a.method),
        _b !== null && _b !== void 0 ? _b : "GET");
    }
    ...
    if (options.cache) {
      options.cacheableRequest = new src$3(
        ...
        (requestOptions, handler) =>
          requestOptions[types.requestSymbol](requestOptions, handler),
        options.cache
      );
    }
    // `options.cookieJar`
    if (dist.default.object(options.cookieJar)) {
      ...
      if (setCookie.length === 4 && getCookieString.length === 0) {
        if (!Reflect.has(setCookie, util.promisify.custom)) {
          ...
          getCookieString = util.promisify(
    ...
    if (
      !Reflect.has(options, "maxRedirects") &&
      !(defaults && Reflect.has(defaults, "maxRedirects"))
    ) {
  ...
  exports.mergeOptions = (...sources) => {
    ...
    const properties = {};
    for (const source of sources) {
      mergedOptions = exports.preNormalizeArguments(
        merge_1.default({}, source),
        mergedOptions
      );
  ...
  exports.normalizeArguments = (url$1, options, defaults) => {
    ...
    if (dist.default.urlInstance(url$1) || dist.default.string(url$1)) {
      ...
      options.url = url$1;
      options = exports.mergeOptions(
        ((_b = (_a = defaults) === null || _a === void 0 ? void 0 : _a.options),
        _b !== null && _b !== void 0 ? _b : {}),
        options
      );
    } else {
      ...
      options = exports.mergeOptions(
        ((_d = (_c = defaults) === null || _c === void 0 ? void 0 : _c.options),
    ...
    Object.defineProperty(normalizedOptions, "prefixUrl", {
      set: value => {
        if (!normalizedOptions.url.href.startsWith(value)) {
          throw new Error(
            `Cannot change \`prefixUrl\` from ${prefixUrl} to ${value}: ${normalizedOptions.url.href}`
          );
        }
        normalizedOptions.url = new url.URL(
          value + normalizedOptions.url.href.slice(prefixUrl.length)
        );
        prefixUrl = value;
      },
      get: () => prefixUrl
  ...
  exports.normalizeRequestArguments = async options => {
    ...
    if (options.body) {
      ...
      if (
        dist.default.object(options.body) &&
    ...
    // body.
    if (
      dist.default.undefined(headers["content-length"]) &&
      dist.default.undefined(headers["transfer-encoding"])
    ) {
      if (
        (options.method === "POST" ||
          options.method === "PUT" ||
    ...
    if (
      ...
      dist.default.undefined(headers.accept)
    ) {
      headers.accept = "application/json";
    }
    if (
      options.decompress &&
      dist.default.undefined(headers["accept-encoding"])
    ) {
      headers["accept-encoding"] = supportsBrotli.default
        ? "gzip, deflate, br"
        : "gzip, deflate";
    }
    // Validate URL
    ...
    if (dist.default.function_(options.request)) {
      ...
      options[types.requestSymbol] =
        options.url.protocol === "https:" ? https.request : http.request;
    }
    // UNIX sockets
    ...
    if (isAgentByProtocol(options.agent)) {
      options.agent =
        ((_b = options.agent[options.url.protocol.slice(0, -1)]),
        _b !== null && _b !== void 0 ? _b : options.agent);
    }
    if (options.dnsCache) {
    ...
    if (options.useElectronNet && process.versions.electron) {
      ...
      options.request = util.deprecate(
        ((_c = electron.net.request),
        _c !== null && _c !== void 0 ? _c : electron.remote.net.request),
...
var calculateRetryDelay_1 = createCommonjsModule(function(module, exports) {
  ...
  const isErrorWithResponse = error =>
    ...
    error instanceof errors.MaxRedirectsError;
  const calculateRetryDelay = ({ attemptCount, retryOptions, error }) => {
    ...
    if (isErrorWithResponse(error)) {
      ...
      if (
        response &&
        Reflect.has(response.headers, "retry-after") &&
...
const { pipeline: streamPipeline, PassThrough: PassThroughStream$1 } = stream;
...
var getResponse = createCommonjsModule(function(module, exports) {
  ...
  exports.default = async (response, options, emitter) => {
    ...
    const progressStream = progress.createProgressStream(
      "downloadProgress",
      emitter,
      downloadBodySize
    );
    ...
    const newResponse =
      options.decompress && options.method !== "HEAD"
        ? decompressResponse_1(progressStream)
        : progressStream;
    if (
      !options.decompress &&
      ["gzip", "deflate", "br"].includes(
        ((_a = newResponse.headers["content-encoding"]),
...
var timedOut = createCommonjsModule(function(module, exports) {
  ...
  exports.default = (request, delays, options) => {
    ...
    const addTimeout = (delay, callback, event) => {
      ...
      (_b = (_a = timeout).unref) === null || _b === void 0
        ? void 0
        : _b.call(_a);
      const cancel = () => {
      ...
      if (socket.connecting) {
        const hasPath = Boolean(
          socketPath !== null && socketPath !== void 0
            ...
            : net.isIP(
                ((_a =
                  hostname !== null && hostname !== void 0 ? hostname : host),
                _a !== null && _a !== void 0 ? _a : "")
              ) !== 0
        );
        if (
...
var urlToOptions = createCommonjsModule(function(module, exports) {
  ...
  exports.default = url => {
    ...
    const options = {
      protocol: url.protocol,
      hostname:
        dist.default.string(url.hostname) && url.hostname.startsWith("[")
...
var requestAsEventEmitter = createCommonjsModule(function(module, exports) {
  ...
  exports.default = options => {
    ...
    const isAborted = () =>
      typeof currentRequest.aborted === "number" || currentRequest.aborted;
    ...
    const get = async () => {
      let httpOptions = await normalizeArguments.normalizeRequestArguments(
        options
      );
      const handleResponse = async response => {
        ...
        try {
          ...
          if (options.useElectronNet) {
            response = new Proxy(response, {
              get: (target, name) => {
                ...
                return dist.default.function_(value)
                  ? value.bind(target)
                  : value;
              }
            });
          ...
          typedResponse.statusMessage = dist.default.nonEmptyString(
          ...
          typedResponse.isFromCache =
            ((_a = typedResponse.fromCache),
            _a !== null && _a !== void 0 ? _a : false);
          ...
          if (Reflect.has(options, "cookieJar") && rawCookies) {
            let promises = rawCookies.map(async rawCookie =>
              options.cookieJar.setCookie(rawCookie, typedResponse.url)
            );
          ...
          if (
            ...
            Reflect.has(typedResponse.headers, "location") &&
            ...
            if (redirects.length >= options.maxRedirects) {
              throw new errors.MaxRedirectsError(
                typedResponse,
                options.maxRedirects,
                options
              );
            ...
            const redirectBuffer = Buffer.from(
              typedResponse.headers.location,
              "binary"
            ).toString();
            const redirectURL = new url.URL(redirectBuffer, options.url);
            // Redirecting to a different site, clear cookies.
            if (
              redirectURL.hostname !== options.url.hostname &&
              Reflect.has(options.headers, "cookie")
            ) {
              delete options.headers.cookie;
            }
      ...
      const handleRequest = async request => {
        ...
        try {
          ...
          const uploadStream = progress.createProgressStream(
            "uploadProgress",
            emitter,
            httpOptions.headers["content-length"]
          );
          isPiped = true;
      ...
      if (options.cache) {
        ...
        const cacheRequest = options.cacheableRequest(
          httpOptions,
          handleResponse
        );
        ...
        try {
          handleRequest(
            httpOptions[types.requestSymbol](
              options.url,
              httpOptions,
              handleResponse
            )
  ...
  function asPromise(options) {
    ...
    const promise = new pCancelable((resolve, reject, onCancel) => {
      ...
      emitter.on("response", async response => {
        ...
        if (
          (_a = response.req) === null || _a === void 0 ? void 0 : _a.aborted
        ) {
        ...
        try {
          for (const [index, hook] of options.hooks.afterResponse.entries()) {
            ...
            response = await hook(response, async updatedOptions => {
              const typedOptions = normalizeArguments.normalizeArguments(
                normalizeArguments.mergeOptions(options, {
                  ...updatedOptions,
                  retry: {
                    calculateDelay: () => 0
                  },
              ...
              typedOptions.hooks.afterResponse = options.hooks.afterResponse.slice(
                0,
                index
              );
              for (const hook of options.hooks.beforeRetry) {
    ...
    const shortcut = responseType => {
      ...
      const newPromise = promise.then(() =>
        parseBody(body, responseType, options.encoding)
      );
    ...
    promise.json = () => {
      if (
        dist.default.undefined(body) &&
        dist.default.undefined(options.headers.accept)
      ) {
...
var create_1 = createCommonjsModule(function(module, exports) {
  ...
  const getPromiseOrStream = options =>
    options.isStream
      ? asStream_1.default(options)
      : asPromise_1.default(options);
  ...
  const create = defaults => {
    ...
    const got = (url, options) => {
      ...
      try {
        return iterateHandlers(
          normalizeArguments.normalizeArguments(url, options, defaults)
        );
      } catch (error) {
    ...
    Object.assign(got, {
      ...errors,
      mergeOptions: normalizeArguments.mergeOptions
    });
    Object.defineProperty(got, "defaults", {
      value: defaults.mutableDefaults
        ? defaults
        : deepFreeze_1.default(defaults),
...
function hasFields(json, fields) {
  if (Array.isArray(fields)) {
    ...
    while (n--)
      for (var l in json)
        if (isIn(l, fields) && /^\s*$/.test(json[l])) return false;
  } else if (typeof fields === "object") {
    for (var key in fields)
      if (json[key] !== undefined && json[key] !== fields[key]) return false;
  } else {
    for (var k in json) if (k === fields && /^\s*$/.test(json[k])) return false;
  }
  return json;
}
...
var clean = {
  ...
  forFields: function(json, fields) {
    if (typeof json === "object" && !Array.isArray(json))
      ...
      var spliced = [];
      var n = json.length;
      while (n--) if (hasFields(json[n], fields)) spliced.push(json[n]);

      if (spliced.length) return spliced;
      else return false;
    } else
  ...
  dups: function(array) {
    ...
    while (i--) if (sorted[i + 1].id === sorted[i].id) sorted.splice(i, 1);
...
var random = {
  text: async function(options) {
    if (!options.mirror) return new Error("No mirror given to random.text()");

    try {
      const data = await latest.id(options.mirror);

      if (!options.count || !parseInt(options.count)) options.count = 1;
      ...
      while (texts.length < options.count) {
        ...
        if (options.fields) {
          ...
          const urlStringLength = `${options.mirror}/json.php?ids=&fields=*`
            .length;
          while (picks.join(",").length < urlStringLength - len)
            picks.push(rInt(1, data));
        } else {
          while (n--) picks.push(rInt(1, data));
        }
        ...
        try {
          ...
          if (filters && Array.isArray(filters)) {
            ...
            while (f--) {
              ...
              if (cleaned) cleaned = clean.forFields(cleaned, filters[f]);
            }
            if (cleaned) texts = texts.concat(cleaned);
          } else if (filters) {
            cleaned = clean.forFields(raw, filters);
            if (cleaned) texts = texts.concat(cleaned);
          } else texts = texts.concat(raw);

          // prevent TypeErrors if nothing has been added to the array
          if (texts.length) texts = clean.dups(texts);
        } catch (err) {
          return err;
        }
      }
...
var search = async function(options) {
  try {
    ...
    if (ids.length > options.count) ids = ids.slice(0, options.count);
...
var check = function(json, field, value) {
  if (/^\s*$/.test(json[field.toLowerCase()])) return false;
  else if (value) return json[field.toLowerCase()] === value;
  else return true;
};
...
XMLReader.prototype = {
  parse: function(source, defaultNSMap, entityMap) {
    ...
    parse$2(source, defaultNSMap, entityMap, domBuilder, this.errorHandler);
